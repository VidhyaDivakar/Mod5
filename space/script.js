console.log("This space script is connected");
const solarSystem = [
...
solarSystem[2].diameter = "7917.5 miles"; // push works only on array not on objects. 
...
console.log("The mass of the mercury is " +"" + system.mercury.mass);

// 2. console.log the eccentricity of Venus
console.log("The eccentricity of the venus is " +"" + system.venus.eccentricity);

// 3. console.log the sum of the number of satellites of Jupiter, Saturn, Uranus, and Neptune (131)

const selectedPlanets = ["jupiter", "saturn", "Uuanus", "neptune"];
let sum =0;
...
console.log("The sum of the satellites Jup, Sat, Uran, Nep" + "" + system);
